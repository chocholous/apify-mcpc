...
```
-H "User-Agent: apify-agent-skills/apify-mcpc-1.4.0/<action>"
```
...
Example:
```bash
mcpc -H "User-Agent: apify-agent-skills/apify-mcpc-1.4.0/search" @apify tools-call search-actors keywords:="instagram"
```
